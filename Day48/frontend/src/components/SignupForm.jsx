...
import { myRegister } from "../states/authSlice";
...
function SignupForm() {
  ...
  const onRegister = async (data) => {
    ...
    try{
        const response = await dispatch(myRegister({username : username.toLowerCase() , email : email.toLowerCase() , password : password})).unwrap();
